...
useEffect(() => {
  ...
  const handleUpdate = async (field) => {
    ...
    // 💡 Security Check: Prevent email updates on frontend
  ...
  // Inside Profile.jsx, before the "return (" line
const handleLogout = () => {
  ...
  const EditableField = ({ label, value, fieldName, icon }) => {
    ...
    // 💡 New: Identify if the field should be locked
        ...
        <div className="flex items-center justify-between gap-4 h-10">
          {isThisEditing ? (
            ...
            <>
              ...
              {/* 💡 Only show edit button if the field is NOT locked */}
              {!isLocked ? (
                <button 
                ...
                <span className="opacity-40 grayscale group-hover:opacity-100 transition-opacity">
